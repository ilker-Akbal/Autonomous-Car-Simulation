...
def generate_launch_description():
    ...
    return LaunchDescription([
        ...
        SetEnvironmentVariable("TL_ACTIVE_ROI_X_MIN", "0.20"),
        SetEnvironmentVariable("TL_ACTIVE_ROI_X_MAX", "0.95"),
        SetEnvironmentVariable("TL_ACTIVE_ROI_Y_MIN", "0.02"),
        SetEnvironmentVariable("TL_ACTIVE_ROI_Y_MAX", "0.75"),
            ...
            actions=[
                Node(
                    ...
                    parameters=[{
                        ...
                        "traffic_light_state_conf_threshold": 0.45,
