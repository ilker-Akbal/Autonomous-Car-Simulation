...
def generate_launch_description():
    ...
    return LaunchDescription([
        ...
        SetEnvironmentVariable("TL_ACTIVE_ROI_X_MIN", "0.18"),
        SetEnvironmentVariable("TL_ACTIVE_ROI_X_MAX", "0.72"),
        ...
        SetEnvironmentVariable("TL_SIMPLE_GREEN_CONF", "0.42"),
        ...
        SetEnvironmentVariable("TL_ACTIVE_MIN_BOTTOM_RATIO", "0.06"),
        ...
        SetEnvironmentVariable("TL_ACTIVE_RED_MIN_AREA_RATIO", "0.00012"),
        SetEnvironmentVariable("TL_ACTIVE_RED_MIN_WIDTH_RATIO", "0.0045"),
        SetEnvironmentVariable("TL_ACTIVE_RED_MIN_HEIGHT_RATIO", "0.018"),
        SetEnvironmentVariable("TL_ACTIVE_GREEN_MIN_AREA_RATIO", "0.00030"),
        SetEnvironmentVariable("TL_ACTIVE_GREEN_MIN_WIDTH_RATIO", "0.0080"),
        SetEnvironmentVariable("TL_ACTIVE_GREEN_MIN_HEIGHT_RATIO", "0.030"),
        ...
        SetEnvironmentVariable("TL_ACTIVE_GREEN_MIN_DET_CONF", "0.25"),
        SetEnvironmentVariable("TL_ACTIVE_GREEN_MIN_STATE_CONF", "0.80"),
            ...
            actions=[
                Node(
                    ...
                    parameters=[{
                        ...
                        "red_light_latch_seconds": 8.0,
                        "red_light_min_green_release_count": 1,
                        "tl_green_release_min_count": 1,
                        "tl_green_release_max_distance_m": 45.0,
                        "tl_green_release_min_height_ratio": 0.030,
                        "tl_green_release_min_area_ratio": 0.00030,
                        "tl_green_release_min_state_conf": 0.80,
                        "tl_green_release_min_det_conf": 0.25,
                        ...
                        "tl_red_no_distance_stop_height_ratio": 0.025,
                        "tl_red_no_distance_stop_area_ratio": 0.00018,
                        "tl_red_raw_stall_epsilon_m": 0.70,
                        "tl_red_memory_decay_mps": 4.2,
                        "tl_red_far_approach_speed_kmh": 20.0,
