...
setup(
    ...
    entry_points={
        'console_scripts': [
            ...
            'behavior_supervisor_node = teknofest_planning.behavior_supervisor_node:main',
            ...
            'traffic_sign_detector_node = teknofest_perception.traffic_sign_detector_node:main',
            ...
            'perception_advisory_visualizer_node = teknofest_perception.perception_advisory_visualizer_node:main',
            'carla_viewport_overlay_node = teknofest_perception.carla_viewport_overlay_node:main',
        ],
    },
)
